...
let allowedOrigins = ['https://my-flix-8675-e6ac611a51d9.herokuapp.com', 'http://localhost:4200', 'http://localhost:8080', 'http://localhost:1234', 'https://myflix8675.netlify.app'];
app.use(cors({
